import { stringify_default } from './MD5';

function a0_0x10f4ac(t, e) {
  console.log('a0_0x10f4ac params is', t, e);
...
function a0_0x3693(t, e) {
  ...
  return (a0_0x3693 = function(t, e) {
    console.log('return function a0_0x3693 params is', t, e);
    console.log('result is', r[t -= 131]);
    return r[t -= 131];
  }
  )(t, e)
}
...
export const X_S_Common = encrypt_b64Encode(encrypt_encodeUtf8(stringify_default()(h)));
