...
const myWindow = dom.window;

myWindow.HTMLCanvasElement.prototype.getContext = function(...params) {
...
(function() {
    function Sanji() {
        var maxLength = 2147483647
          , trueNumber = 1
          , falseNumber = 0
          , trueFlag = !!trueNumber
          , falseFalg = !!falseNumber;
        return function(_ace_4752e, _ace_aa949, _ace_be07c) {
            var _ace_a3718 = []
              ...
              , _ace_d4acc = {}
              , _ace_6458 = falseNumber
              , _ace_0edd5 = [];
            var decode = function(mappingStr) {
                if (!mappingStr) {
                    return ""
                }
                var n = function(e) {
                ...
                var p = mappingStr.length;
                var l = 0;
                var m = [];
                while (l < p) {
                    var s = k.indexOf(mappingStr.charAt(l++));
                    var r = k.indexOf(mappingStr.charAt(l++));
                    var q = k.indexOf(mappingStr.charAt(l++));
                    var o = k.indexOf(mappingStr.charAt(l++));
                    var i = (s << 2) | (r >> 4);
                    var h = ((r & 15) << 4) | (q >> 2);
                    var g = ((q & 3) << 6) | o;
            ...
            var _ace_44c663 = function(_ace_3b92a, _ace_9670d) {
                return _ace_9670d.hasOwnProperty(_ace_3b92a) ? trueFlag : falseFalg;
            };
            var _ace_44c662 = function(_ace_3b92a, _ace_9670d) {
                if (_ace_44c663(_ace_3b92a, _ace_9670d)) {
                    return _ace_b81ca(falseNumber, _ace_9670d, _ace_3b92a, trueNumber);
                }
                var _ace_4d487;
            ...
            var _ace_44c66 = function(_ace_3b92a) {
                ...
                return _ace_b81ca(falseNumber, _ace_66, _ace_3b92a, trueNumber);
            };
            ...
            var _ace_c7cc7 = function() {
                _ace_0edd5.push(_ace_b81ca(_ace_6458, falseNumber, falseNumber, falseNumber))
            };
            ...
            var _ace_dcca5 = [_ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber), _ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber), _ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber), _ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber), _ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber)];
            var _ace_4d11 = [_ace_be07c, function _ace_ad126(_ace_5ed3b) {
                return _ace_dcca5[_ace_5ed3b];
            }
            , function(_ace_5ed3b) {
                return _ace_b81ca(falseNumber, _ace_420ea._ace_b0594, _ace_5ed3b, trueNumber);
            }
            , function(_ace_5ed3b) {
                return _ace_44c66(_ace_5ed3b);
            }
            , function(_ace_5ed3b) {
                return _ace_b81ca(falseNumber, _ace_4752e, _ace_aa949.d[_ace_5ed3b], trueNumber);
            }
            , function(_ace_5ed3b) {
                return _ace_b81ca(_ace_420ea._ace_5ee37, falseNumber, falseNumber, falseNumber);
            }
            , function(_ace_5ed3b) {
                return _ace_b81ca(falseNumber, _ace_aa949.d, _ace_5ed3b, trueNumber);
            }
            , function(_ace_5ed3b) {
                return _ace_b81ca(_ace_420ea._ace_b0594, _ace_be07c, _ace_be07c, falseNumber);
            }
            , function(_ace_5ed3b) {
                return _ace_b81ca(falseNumber, _ace_d4acc, _ace_5ed3b, falseNumber)
            }
            ];
            var _ace_ae44 = function(_ace_28434, _ace_5ed3b) {
                return _ace_4d11[_ace_28434] ? _ace_4d11[_ace_28434](_ace_5ed3b) : _ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber);
            };
            var _ace_34d1 = function(_ace_28434, _ace_5ed3b) {
                return _ace_8cba0(_ace_ae44(_ace_28434, _ace_5ed3b));
            };
            var _ace_1ae3c = function(_ace_d656a, _ace_7e97a, _ace_5ed3b, _ace_0a916, p4 = undefined) {
                _ace_dcca5[falseNumber] = _ace_b81ca(_ace_d656a, _ace_7e97a, _ace_5ed3b, _ace_0a916)
            };
            var _ace_99485 = function(_ace_2d9a) {
                var _ace_7d4cc = falseNumber;
                while (_ace_7d4cc < _ace_2d9a.length) {
                    var _ace_b34db = _ace_2d9a[_ace_7d4cc];
                    var _ace_416e1 = _ace_aec23[_ace_b34db[falseNumber]];
            ...
            var _ace_2437 = function(_ace_a135, _ace_7577, _ace_b34db, _ace_2d9a) {
                ...
                while (_ace_54be < _ace_d4347) {
                    ...
                    var _ace_416e1 = _ace_aec23[x[falseNumber]];
            ...
            var _ace_ea2b3 = function(_ace_d939, _ace_2d9a) {
                ...
                try {
                    ...
                    _ace_dcca5[2] = _ace_b81ca(e, falseNumber, falseNumber, falseNumber);
                    _ace_d939 = _ace_2437(_ace_0c1a0[2], _ace_0c1a0[3], _ace_d939, _ace_2d9a);
                    _ace_dcca5[2] = _ace_b81ca(falseNumber, falseNumber, falseNumber, falseNumber);
                } finally {
            ...
            var _ace_75a05 = decode(_ace_aa949.b).split('').reduce(function(_ace_664b, _ace_b34db) {
                if ((!_ace_664b.length) || _ace_664b[_ace_664b.length - trueNumber].length == 5) {
                    _ace_664b.push([]);
                }
                _ace_664b[_ace_664b.length - trueNumber].push(-trueNumber * 1 + _ace_b34db.charCodeAt(0));
                return _ace_664b;
            }, []);
...
console.log(myWindow._webmsxyw('/api/sns/web/v1/login/activate', {}))

export const getXHeader = (url: string) => {
    return myWindow._webmsxyw(url);
};
