const MD5 = (function (t) {
    ...
    function (t, e, r) {
        !(function () {
            var e = r(2), n = r(0).utf8, o = r(3), i = r(0).bin, a = function t(r, a) {
                ...
                for (var u = e.bytesToWords(r), c = 8 * r.length, s = 1732584193, l = -271733879, f = -1732584194, p = 271733878, h = 0; h < u.length; h++)
                    u[h] = (16711935 & ((u[h] << 8) | (u[h] >>> 24))) | (4278255360 & ((u[h] << 24) | (u[h] >>> 8)));
                (u[c >>> 5] |= 128 << c % 32), (u[14 + (((c + 64) >>> 9) << 4)] = c);
                var d = t._ff, v = t._gg, g = t._hh, m = t._ii;
            ...
            var e = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/', r = {
                ...
                base64ToBytes: function (t) {
                    ...
                    for (var r = [], n = 0, o = 0; n < t.length; o = ++n % 4)
                        0 != o &&
                            r.push(((e.indexOf(t.charAt(n - 1)) & (Math.pow(2, -2 * o + 8) - 1)) << (2 * o)) |
